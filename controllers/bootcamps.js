...
exports.getBootcamps=asyncHandler(async (req,res,next)=>{
    ...
    exports.getBootcamp=asyncHandler(async (req,res,next)=>{
            ...
            if(!bootcamp){
                ...
                return next(new ErrorResponse(`Bootcammm with id ${req.params.id} not found `,404));
            }
...
// Path: backend\devcamper_project_resources\devcamper_theme\devcamper_api\routes\bootcamps.js
